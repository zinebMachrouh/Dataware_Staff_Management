    ...
    <div class="create-form">
        ...
        <form action="" method="post">
            ...
            <div class="labels lg">
                ...
                <label for="matricule">
                    <h4>Matricule</h4>
                    <input type="text" name="matricule" id="matricule" placeholder="X00N">
                </label>
            </div>
            <div class="labels med">
                <label for="birthday">
            ...
            <label for="adresse" class="sm">
                <h4>Adresse</h4>
                <input type="text" name="adresse" id="adresse" placeholder="1220 Dream Street Fantasyland, FL 54321 United Imaginary States">
            </label>
            <div class="labels x-lg">
                ...
                <label for="team">
                    ...
                    <select name="team" id="team">
                        <option value="" hidden>Pick Team</option>
                        <?php 
            ...
            <label for="pswd" class="sm">
                <h4>Password</h4>
                <input type="password" name="pswd" id="pswd" placeholder="XXXXXXXX">
            </label>
            <div class="btns">
                <button type="reset">Cancel</button>
                <button type="submit" name="addOne">Submit</button>
            </div>
        </form>
    </div>
    <?php
        ...
        if (isset($_POST["addOne"])) {
            ...
            mysqli_query($connect, "INSERT INTO users (`matricule`, `nom`, `prenom`, `date_naissance`, `service`, `adresse`, `tel`, `email`, `password`, `id_equipe`, `status`) VALUES ('$matricule', '$nom', '$prenom', '$birthday', '$service', '$adresse', $tel, '$email', '$pswd', $team, '$status')");
