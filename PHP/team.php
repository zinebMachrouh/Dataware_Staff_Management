        ...
        <main>
            <div class="cards" style="height: 91vh;">
                <?php 
                    ...
                    $users = mysqli_query($connect, "Select * from users inner join team on team.idEquipe = users.id_equipe where deleted = 0 and idEquipe = $id order by id asc ");
